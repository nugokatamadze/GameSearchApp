...
object GameUtils {
    ...
    val gamesList = listOf(
        Game(
            ...
            "https://image.api.playstation.com/cdn/HP4497/CUSA01490_00/qiMTmGrZfSPfLDbfeLvBUXwEfpcSNQgi.png"
        ),
        Game(
            "Far Cry 3",
            ...
            "https://www.trustedreviews.com/wp-content/uploads/sites/54/2018/06/far-cry-3-classic-edition-1024x576.jpg"
        ),
        Game(
            "The Last Of Us Part I",
            "The Last of Us is played from a third-person perspective. Players use firearms and improvised weapons, and can use stealth to defend against hostile humans and cannibalistic creatures infected by a mutated fungus in the genus Cordyceps.",
        ...
        Game(
            ...
            "https://static.wikia.nocookie.net/assassinscreed/images/2/2a/Assassins_Creed_brotherhood_cover.jpg/revision/latest/top-crop/width/360/height/360?cb=20210519124648"
        ),
        Game(
            "Doom",
        ...
        Game(
            ...
            "https://mir-s3-cdn-cf.behance.net/project_modules/1400/c730b28869985.5602ca3e17e4a.jpg"
        ),
        Game(
            "Cuphead",
        ...
        Game(
            "Mafia II",
            "Vito Scaletta has started to make a name for himself on the streets of Empire Bay as someone who can be trusted to get a job done. Together with his buddy Joe, he is working to prove himself to the Mafia, quickly escalating up the family ladder with crimes of larger reward, status and consequence… the life as...",
            "https://store.playstation.com/store/api/chihiro/00_09_000/container/SE/en/99/EP1001-NPEB02413_00-MAFIAIIPSNGAME04/0/image?_version=00_09_000&platform=chihiro&bg_color=000000&opacity=100&w=720&h=720"
        ),
        Game(
        ...
        Game(
            ...
            "https://gmedia.playstation.com/is/image/SIEPDC/marvels-spider-man-desktop-wallpaper-03-en-15dec20?$\\native--t\\$"
        ),
        Game(
            "Far Cry 4",
            ...
            "https://image.api.playstation.com/cdn/EP0001/CUSA00462_00/OPzG8aG5jQWeg68qJzipxeTqz4ZwvOx3b28JEZxzRpIjeIYYDkPZRHvSOqjOetug.png"
        ),
        Game(
            "Resident Evil 2",
        ...
        Game(
            ...
            "https://www.gamespot.com/a/uploads/scale_landscape/1578/15787979/3486317-5667056386-DwkeHvnWwAA93HE.jpg%3Alarge"
        ),
        Game(
            "Heavy Rain",
